...
class Curved extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.shader =  LinearGradient(
      ...
      stops: const [.01, .25],
      colors: [
        AppTheme.colors.primary.withOpacity(.95),
        AppTheme.colors.primary.withOpacity(.6)
      ],
    ).createShader(rect);
    ...
    paint2.shader =  LinearGradient(
      ...
      stops: const [.05, 1],
      colors: [
        AppTheme.colors.secondary.withOpacity(.6),
        AppTheme.colors.secondary.withOpacity(.95)
      ],
    ).createShader(rect);
