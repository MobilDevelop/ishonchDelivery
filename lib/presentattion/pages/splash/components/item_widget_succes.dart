...
class ItemWidgetSucces extends StatelessWidget {
  const ItemWidgetSucces({
    super.key, required this.item,
  });
 final SuccesItem item;
  @override
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: Text(item.pruductId.toString(),
            ...
            Row(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(tr("splash.datetime"),style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: AppTheme.colors.primary)),
                      Text(item.dateTime,
